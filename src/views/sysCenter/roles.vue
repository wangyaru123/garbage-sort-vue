<template>
  ...
  <div class="p-10">
    ...
    <el-table :data="currentTableData" border stripe class="mt-10">
      ...
      <el-table-column label="角色" fixed align="center" min-width="100px">
        <template slot-scope="scope">
...
export default {
  data() {
    return {
      ...
      // table所有数据
      tableData: [
        { userId: 1, username: '系统管理员', name: '王一', role: 1, mobile: '15076541233', email: '2434243562@163.com', sex: 0, address: '浙江杭州', projectId: 1 },
        { userId: 2, username: '商家管理员', name: '张山', role: 2, mobile: '15076541231', email: '2434243561@163.com', sex: 0, address: '安徽合肥', projectId: 2 }
      ],
      // 当前tableData数据
      currentTableData: [],
      // 项目列表
